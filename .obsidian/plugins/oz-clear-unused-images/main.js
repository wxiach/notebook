...
const i = { deleteOption: '.trash', logsModal: !0, excludedFolders: '', ribbonIcon: !1, excludeSubfolders: !1 }
class s extends e.PluginSettingTab {
  ...
  display() {
      ...
      new e.Setting(t)
        ...
        .addToggle((e) =>
          e.setValue(this.plugin.settings.ribbonIcon).onChange((e) => {
            ;(this.plugin.settings.ribbonIcon = e), this.plugin.saveSettings(), this.plugin.refreshIconRibbon()
          })
        ),
      new e.Setting(t)
        .setName('Delete Logs')
      ...
      new e.Setting(t)
        ...
        .addDropdown((e) => {
          e.addOption('permanent', 'Delete Permanently'),
            ...
            e.onChange((e) => {
              ;(this.plugin.settings.deleteOption = e), this.plugin.saveSettings()
            })
        }),
      new e.Setting(t)
        ...
        .addTextArea((e) =>
          e.setValue(this.plugin.settings.excludedFolders).onChange((e) => {
            ;(this.plugin.settings.excludedFolders = e), this.plugin.saveSettings()
          })
        ),
      new e.Setting(t)
        ...
        .addToggle((e) =>
          e.setValue(this.plugin.settings.excludeSubfolders).onChange((e) => {
            ;(this.plugin.settings.excludeSubfolders = e), this.plugin.saveSettings()
          })
        )
    ...
    i
      ...
      .createEl('img', { attr: { src: 'https://cdn.ko-fi.com/cdn/kofi2.png?v=3' } }).height = 45
  }
}
class n extends e.Modal {
  ...
  onOpen() {
    ...
    i.createEl('h1', { text: 'Clear Unused Images - Logs' }).addClass('modal-title')
...
const a = (e, i, s) =>
      ...
      if (n) {
        ...
        for (let a of n) {
          if (h(a)) {
            ...
            if ('' !== s) {
              let i = { type: 'wikiTransclusion', match: a, linkText: n ? n.path : s, sourceFilePath: e.path }
              t.push(i)
              continue
            }
          }
          ...
          if (n) {
            ...
            let s = i.metadataCache.getFirstLinkpathDest(n[0], e.path),
              o = { type: 'wiki', match: a, linkText: s ? s.path : n[0], sourceFilePath: e.path }
            t.push(o)
          }
        }
      }
      ...
      if (a) {
        ...
        for (let n of a) {
          if (c(n)) {
            ...
            if ('' !== s) {
              let i = { type: 'mdTransclusion', match: n, linkText: a ? a.path : s, sourceFilePath: e.path }
              t.push(i)
              continue
            }
          }
          ...
          if (a) {
            ...
            let s = i.metadataCache.getFirstLinkpathDest(a[0], e.path),
              o = { type: 'markdown', match: n, linkText: s ? s.path : a[0], sourceFilePath: e.path }
            t.push(o)
          }
        }
      }
  ...
  v = (e) =>
    t(void 0, void 0, void 0, function* () {
      ...
      if (i)
        for (const [e, s] of Object.entries(i)) for (const [s, n] of Object.entries(i[e])) s.endsWith('.md') || t.add(s)
      ...
      (this.refreshIconRibbon = () => {
        ...
        null === (e = this.ribbonIconEl) || void 0 === e || e.remove(),
          this.settings.ribbonIcon &&
            (this.ribbonIconEl = this.addRibbonIcon('image-file', 'Clear Unused Images', (e) => {
              ...
              t(void 0, void 0, void 0, function* () {
                ...
                for (let n of s)
                  x(n, a)
                    ...
                    : ('.trash' === e
                        ? (yield o.vault.trash(n, !1), (i += '[+] Moved to Obsidian Trash: ' + n.path + '</br>'))
                        : 'system-trash' === e
                          ? (yield o.vault.trash(n, !0), (i += '[+] Moved to System Trash: ' + n.path + '</br>'))
                          : 'permanent' === e &&
                            (yield o.vault.delete(n), (i += '[+] Deleted Permanently: ' + n.path + '</br>')),
                      t++)
                return { deletedImages: t, textToView: i }
              })).then(({ deletedImages: t, textToView: i }) => {
                if (
                  ((e += i),
                  (e += '[+] ' + t.toString() + ' image(s) in total deleted.</br>'),
